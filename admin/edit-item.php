...
<div class="pusher" style="padding-left: 99px; padding-top: 42px;">
    <div class="container mt-4 mb-4">
        <div class="ui breadcrumb">
            ...
            <a href="/admin/menu.php" class="section">Menu Items</a>
            <div class="divider"> / </div>
        ...
        <div class="row mt-4">
            <div class="col-md-8">
                <div class="ui segment">
                    <form class="ui form" action="/actions/update-item.php?id=<?php echo $single_row['id'] ?>" method="post">
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="number" name="price" step="0.01" id="price" required value="<?php echo $single_row['price'] ?>">
                        </div>
                        <div class="field">
                            <label>Image</label>
                        ...
                        <div class="field">
                            ...
                            <select name="category_id" class="ui dropdown" required>
                                ...
                                while ($row = $stmt->fetch()) {
                                    ?>
                                    <option value="<?php echo $row['id'] ?>" <?php if ($single_row['category_id'] == $row['id']) echo 'selected' ?> ><?php echo $row['title'] ?></option>
                                    <?php
                                }
                                ?>
                            </select>
